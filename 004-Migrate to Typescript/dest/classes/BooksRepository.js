...
var TBook_1 = __importDefault(require("./TBook"));
...
var BooksRepository = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, books_1.default.find().select('-__v')];
                    case 1:
                        dbBooks = _b.sent();
                        books = [];
                        i = void 0;
    ...
    BooksRepository.prototype.deleteBook = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var dbBook, title, description, authors, favorite, fileCover, fileName, fileBook, book, e_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        title = dbBook.title, description = dbBook.description, authors = dbBook.authors, favorite = dbBook.favorite, fileCover = dbBook.fileCover, fileName = dbBook.fileName, fileBook = dbBook.fileBook;
                        book = new TBook_1.default(title, description, authors, favorite, fileCover, fileName, fileBook);
                        return [4 /*yield*/, books_1.default.deleteOne({ _id: id })];
                    case 2:
                        _a.sent();
