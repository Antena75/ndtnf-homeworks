...
router.post('/books/create', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, bookrep.createBook(book)];
            case 2:
                books = _b.sent();
                res.redirect('/books');
                return [3 /*break*/, 4];
...
router.get('/books/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, bookrep.getBook(id)];
            case 2:
                book = _a.sent();
...
router.post('/books/update/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, bookrep.updateBook(id, title, description, authors, favorite, fileCover, fileName, fileBook)];
            case 2:
                book = _b.sent();
